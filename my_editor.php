...
<!--image upload files-->
<link href="ajax_upload/css/uploadfilemulti.css" rel="stylesheet">
<script src="ajax_upload/js/jquery.fileuploadmulti.min.js"></script>
...
<div id="queue"></div>
<center>
<div id="mulitplefileuploader" class="col-md-8">Upload</div>
...
<div id="queue"></div><center>
	...
	<!--</form>-->
<div id="mulitplefileuploader2" class="col-md-8">Upload</div>
...
var settings = {
    ...
    {
       // alert("all images uploaded!!");
        $('#frm2').load(window.location.href+ ' #frm2');
...
<a href="#small-dialog" class="popup-with-zoom-anim" ><button class="btn btn-default" >View</button></a>
</div><hr>
<img src="images/compose.png" class="img-thumbnail" width="90px" height="90px">
<div class="btn-group">
