...
(function (e) {
	e.fn.jqte = function (t) {
		...
		var r = [["Arial", "Arial"], ["Times New Roman", "Times New Roman"], ["Calibri", "Calibri"], ["Courier New", "Courier New"], ["Sans Serif", "Sans Serif"], ["Verdana", "Verdana"], ["Comic Sans MS", "Comic Sans MS"], ["Impact", "Impact"]];
		//var i = ["Arial", "Times New Roman", "Calibri", "Courier New", "Sans Serif", "Verdana", "Comic Sans MS","Impact"];
		var i = ["22","20","18","16","14","12","10"];
		...
		return this.each(function () {
			...
			function q(e, t)
			{
				...
				if (n && t == false) {
					...
					var r = t.split(";");
					r = r[0].split(":");
					if (e.is("[style*=font-family]"))//if (e.is("[style*=" + r[0] + "]"))
						e.find("*").css("font-family", r[0]);//e.find("*").css(r[0], r[1]);
					R(e)
				}
			}
			function R(t) {
			...
			h.html('<div class="' + u.css + "_toolbar" + '" role="toolbar" unselectable></div><div class="' + u.css + '_linkform" style="display:none" role="dialog"></div><div class="' + u.css + "_editor" + '" data-placeholder="text goes here....."></div>');
