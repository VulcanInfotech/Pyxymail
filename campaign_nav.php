...
<a href="index.php" class="navbar-brand"><img src="images/pyxymail31.png"></a>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li  style="margin-top:10px;" ><a href="dashboard.php">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Dashbord</b></a></li>
       
        <li style="margin-top:10px;"><a href="audience1.php"> &nbsp;&nbsp;&nbsp;&nbsp;<b>Audience</b></a></li>
        <li style="margin-top:10px;"><a href="campaign_dash.php"> &nbsp;&nbsp;&nbsp;&nbsp;<b>Campaign</b></a></li>
<?php
include 'session1.php';
if(isset($paid_session))
{
         echo "                  <li style='margin-top:10px;'><a href='pricing_signups.php'>&nbsp;&nbsp;&nbsp;&nbsp;<b>Pricing</b></a>   </li>";
}
?>
<?php
include 'session1.php';
...
{
         echo "                  <li style='margin-top:10px;'><a href='pricing_signups.php'>&nbsp;&nbsp;&nbsp;&nbsp;<b>Pricing Plans</b></a>   </li>";
}
?> 
<li style="margin-top:10px;"><a href="account.php"> &nbsp;&nbsp;&nbsp;&nbsp;<b>Myaccount</b></a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li style="margin-top:10px;"><a href="logout.php"> <b><?php include 'session1.php';  echo $paid_user;  echo $login_session;?></b>
...
';	     
                                                            $sql2="select * from promotion_sent where id='$ids' order by date DESC";
                                                            $query2=mysqli_query($conn,$sql2);
                                                            $row3=mysqli_fetch_assoc($query2);
                                                            $sent=$row3['email'];
                                                            $sent_date=$row3['date'];
