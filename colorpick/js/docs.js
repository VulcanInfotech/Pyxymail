...
function updateBorders(color) {
	...
	if(selectedtext != "")
	{
		var OGString = document.getElementById('docs-content').innerHTML;
		var NewString = OGString.replace(selectedtext,"<font color='"+hexColor+"'>"+selectedtext+"</font>");
		document.getElementById('docs-content').innerHTML=NewString;
	}
	//$("#textselector").css("background-color", hexColor);
	//$("body").css("background-color", hexColor);
	//$("#docs-content").css("color", hexColor);
	//alert(NewString);
}
