...
<li style="margin-top:10px;"><a href="account.php"  style="font-family: Helvetica Neue,Arial,Helvetica,sans-serif;font-size: 12px;font-weight: bold;line-height: 1.75;letter-spacing: 0.04em;color: #3a3a3a; text-align: center;height: 62px;line-height: 62px;padding: 0 28px;"> &nbsp;&nbsp;&nbsp;&nbsp;<b>Myaccount</b></a></li>
 ...
 <i class="fa fa-sign-out fa-1x"></i></a></li>
		...
		<div id="headerwrap" style="padding-top:40px;">
	    <div class="container">
	    	<div class="wrap"  >
 	<div class="plans">
        <div class="col-md1" >
			 <div class="pricing-table-grid">
				...
				<ul style=" background-color:white ">
					...
					<form action="paidsession.php" method="GET" style="background:#2c3e50;" class="plans_head">
                                                                   <input type="hidden" value="1" name="idno">
                                                                   <input type="submit" class="btn " style="background:#2ecc71; color:white;"  value="Purchase"  >
...
<h6 style="color:white;"> Best Value</h6>
				...
				<ul style="background: white;">
					...
					<li ><span style="color: black;"> ∞ emails</span></li>
					 ...
					 <form action="paidsession.php" method="GET" style="background:#2c3e50;" class="plans_head">
                                                          <input type="hidden" value="11" name="idnos">
<input type="submit" class="btn " style="background:#2ecc71; color:white;"  value="Purchase" ></li>
				 <!--a class=" button" href="#" style="background: rgba(61, 61, 61, 0.81);"><i> </i>Purchase</a-->
</form>			   
		         </div>
		     </div>
		 <div class="col-md1" >
...
<li style="background:#2c3e50; " class="plans_head"><input type="submit"  class="btn " style="background:#2ecc71; color:white;" value="Purchase" target="_blank"></li>
</form></ul>

				 <!--<a class="button" style="background: rgba(61, 61, 61, 0.81);" href="paidsession.php"><i> </i>Purchase</a>-->	   
		         </div>
		     </div>
		    <div class="clear"> </div>								
       </div>
