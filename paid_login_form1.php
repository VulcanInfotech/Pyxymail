...
<div class="row">  
  ...
  <a class="hiddenanchor" id="toregister"></a>
	...
	//font-weight: bold;
	text-align: center;
	padding-bottom: 0px;">Guest-Log in</h2><br>
...
<a href="#toregister" class="to_register "><button class="btn" style="
	...
	-webkit-transition: all 0.2s linear;
	   -moz-transition: all 0.2s linear;
	     -o-transition: all 0.2s linear;
	        transition: all 0.2s linear; margin-left:12px;margin-top:-100px;"><p style="margin-top:-3px;">Premium Login</p></button></a> </h2><br>
	...
	//font-weight: bold;
	text-align: center;
	padding-bottom: 0px;">Premium Log In</h2> <br>
...
<a href="#tologin" class="to_register"><button class="btn col-md-5" style="
	...
	-webkit-transition: all 0.2s linear;
	   -moz-transition: all 0.2s linear;
	     -o-transition: all 0.2s linear;
	        transition: all 0.2s linear; margin-left:12px;margin-top:-60px; "><p style="margin-top:-3px;">Guest Login</p></button></a><br>
      </div>
...
<h2 class="grid-heading" style="margin-top:100px;font-size:22px;font-family: "Roboto Slab", serif; color:#3f5348;" id="txt1">If You are Using Our Premium Services, Then Click Here for Login</h2><br>
                                                               <p>
									
									<a href="#toregister" class="to_register"><button class="btn"style="color:white;background:#f69730; padding:6px; width:130px; margin-left:12px;"  id="btn1">Click Here</button></a>

<div id="toregister" class="animate form">                                                               
 <p class="change_link"> 
							<h2 class="grid-heading" style="margin-top:40px;font-size:22px; font-family:"Roboto Slab", serif; color:#3f5348;" id="txt2">Back To free Login </h2><br>
									<a href="#tologin" class="to_register"> <button class="btn" style="color:white;background:#f69730;  padding:6px;width:130px; margin-left:12px; "  id="btn2">Click Here</button></a>
							</p>
</div>
                                                     ...
                                                     <div id="small-dialog" class="mfp-hide " style="height:300px;  " >
									<div class="pop_up" >
									 	<div class="payment-online-form-left" style="margin-top:30px;  ">
                                                               
											<form action="forgotpassword.php" method="post"  >
                                          						<ul class="payment-sendbtns" style="float:left; ">

                                      <li ><label class="col-md-12" style="font-weight:bold;"> Enter your Email: </label></li>
		                        <li ><input id="useremail" type="email" class="col-md-12" name="useremail" /></li><br><br>
                                       
                                       <li><label style="font-weight:bold;"></label></li>
					<li ><input type="Submit" value="Get Your Password" ></li>
...
<div id="small-dialog1" class="mfp-hide " >
									<div class="pop_up">
									 	<div class="payment-online-form-left">
											<form action="paidforgotpassword.php" method="post" >
...
<div id="error2"> </div>
 ...
 <li><label style="font-weight:bold;"> Enter your Email: </label></li>
		                        <li style="margin-left:10px;"><input id="useremail" type="email" name="useremail" /></li><br><br>
