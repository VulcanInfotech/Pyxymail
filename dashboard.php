...
<div class="panel panel-default">
    <div class="panel-heading" style="background-color:#34495e;"><b style="color:white;font-weight:bold;">Create Promotions</b></div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-2">
                <a href="#">
                    <img class="img-responsive" src="images/promotion.png" height="60%" width="60%" alt="Create Promotions">
                </a>
            </div>
            ...
            <div class="col-md-3">
                <a href="#">
                    <a class="btn btn-primary btn-lg" href="upload_image.php">Create Promotion <!--span class="glyphicon glyphicon-chevron-right"></span--></a>
                </a>
            </div>
        </div>
        <!-- /.row -->
...
<br>
  ...
  <div class="panel panel-default">
    <div class="panel-heading" style="background-color:#34495e;"><b style="color:white;font-weight:bold;">Create & Send Campaign</b></div>
    <div class="panel-body">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-2">
                <a href="#">
                    <img class="img-responsive" src="images/campaign1.png" height="60%" width="60%" alt="Create & Send Campaign">
                </a>
            </div>
            ...
            <div class="col-md-3">
                <a href="#">
                    <a class="btn btn-primary btn-lg" href="campaign_dash.php">Show&nbsp;&nbsp;Campaign&nbsp;&nbsp;<!--span class="glyphicon glyphicon-chevron-right"></span--></a>
                </a>
            </div>
        </div>
        <!-- /.row -->
...
<br>
  <div class="panel panel-default">
    <div class="panel-heading" style="background-color:#34495e;"><b style="color:white;font-weight:bold;">Create Audience</b></div>
    <div class="panel-body">
...
<!-- Page Content -->
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-2">
                <a href="#">
                    <img class="img-responsive" src="images/audience2.png" height="60%" width="60%" alt="Create Audience">
                </a>
            </div>
            ...
            <div class="col-md-3">
                <a href="#">
                    <a class="btn btn-primary btn-lg" href="audience1.php">Create &nbsp;&nbsp;Audience <!--span class="glyphicon glyphicon-chevron-right"></span--></a>
                </a>
            </div>
        </div>
        <!-- /.row -->
...
<br>
  <div class="panel panel-default">
    <div class="panel-heading" style="background-color:#34495e;"><b style="color:white;font-weight:bold;">Pricing</b></div>
    <div class="panel-body">
...
<!-- Page Content -->
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-2">
                <a href="#">
                    <img class="img-responsive" src="images/pricing.png" alt="Create Audience">
                </a>
            </div>
            ...
            <div class="col-md-3">
                <a href="#">
                    <a class="btn btn-primary btn-lg" href="pricing_signups.php">&nbsp;&nbsp;Purchase &nbsp;&nbsp;Plans&nbsp;&nbsp; <!--span class="glyphicon glyphicon-chevron-right"></span--></a>
                </a>
            </div>
        </div>
        <!-- /.row -->
