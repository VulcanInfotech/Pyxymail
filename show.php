...
<div class="main-header2">
               <div  class="menu-wrapper">
                       ...
                       <li><a><i class="fa fa-user"></i>&nbsp;&nbsp;<?php include 'session.php'; echo $login_session ?><b class="caret"></b></a>
                       <ul>
            ...
            <div class="main-header">
             ...
             <div id="responsive-menu">
                <ul>
                           ...
                           <li><a href="pricing_signups.php">Upgrade</a>   </li>
                            <li><a href="help.php">Help</a >      </li>
                            <li><a><i class="fa fa-user"></i>&nbsp;&nbsp;<?echo $login_session; ?></a>
                                    <ul>
...
<li>
          ...
          <div id="tab-content1" class="tab-content animated fadeIn" style="width:790px;">
...
<div class="dashright" style= " background-color:ff9933; margin-top:-250px;margin-right:-80px;"><br>
...
<fieldset style="border:solid 1px #000;width:90%;margin-left:20px; background-color:#fff; height:150px;"><br><br>
 List name &nbsp; &nbsp; <input type="text" name="lname" placeholder="Enter list name..." ><br><br><br>
...
<div style="line-height:60px;border-bottom: 1px solid black;text-align:left;background-color:#ddd">&nbsp;&nbsp; <u>Contact details</u></div><BR>
...
<div style="border-top: 1px solid black;"></div><br>
<input type="submit" name="submit" value="Save" style="background-color:orange; color:#fff;" >&nbsp;&nbsp;&nbsp;
<input type="button"  value="Cancel" class="cls"><BR>
</form>
</div>
               </div> <!-- /.row -->
               <div style="text-align:center;font-size:20px;"><U>All Contact Details</U></div><br><br>
                      <center>
					 <div class="pull-center" style="overflow:auto;
...
echo "<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>";
echo "<td><font size='4'><b>Listname</font></b></td>";
echo "<td>&nbsp;&nbsp;&nbsp;</td>";

echo "<td align='right'><font size='4'><b>List&nbsp;Members</font></b></td>";
...
while($row=mysqli_fetch_array($query))
{
	...
	echo "<td><font size='2'>".$row[1]."</font></td>";
		...
		echo "<td align='right'><font size='2'>".$row[3]."</font></td>";
...
<a href="dashboard2.php"><br><br>Previous</a>
</div>
