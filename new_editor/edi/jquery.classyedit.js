...
(function(a) {
    ...
    a.fn.ClassyEdit = function(c) {
        ...
        "undefined" == typeof a.fn.ClassyEdit.counter ? a.fn.ClassyEdit.counter = 0 : a.fn.ClassyEdit.counter++;
        ...
        g = g + '</div><div id="editor_1" class="editor"  contenteditable="true" data-placeholder="You can insert & edit content here."><h4 class="ed">You can insert & edit content here...</h4>' + f.val() + '</div><textarea class="html_editor">' + f.val() + "</textarea></div>";
        f.hide();
        f.after(g);
   ...
   $('.ed').css('color','#ccc');     
        				 ...
        				 var $editor = $(".editor").length;
				$(".editor:last").attr("id","editor_"+$editor++);
