...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></a>
 ...
 <li><a class="logout btn btn-warning" href="login.html"><i class="fa fa-floppy-o">&nbsp;LOGOUT</i></a></li>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <div class="btn-group" >
                          <button type="button" class="btn btn-default " style="background:#f2f2f2;"><i class="fa fa-bold"></i></button>
  <button type="button"  class="btn btn-default" style="background:#f2f2f2;">&nbsp;&nbsp;<i class="fa fa-italic"></i></button></div>
                  </li>

                 <li class="mt">
                      <div class="btn-group" >
                         <button type="button"  class="btn btn-default" style="background:#f2f2f2;"><i class="fa fa-underline"></i></button>
   <button type="button" class="btn btn-default " style="background:#f2f2f2;"><i class="fa fa-align-left"></i></button></div>
                  </li>

                 <li class="mt">
                      <div class="btn-group">
                         <button type="button"  class="btn btn-default" style="background:#f2f2f2;"><i class="fa fa-align-right"></i></button>
  <button type="button"  class="btn btn-default" style="background:#f2f2f2;"><i class="fa fa-align-right"></i></button></div>
                  </li>
                 <li class="mt">
                      <div class="btn-group">
                          <button type="button" class="btn btn-default " style="background:#f2f2f2;"><i class="fa fa-list-ol"></i></button>
  <button type="button"  class="btn btn-default" style="background:#f2f2f2;"><i class="fa fa-list-ul"></i></button></div>
                  </li>
				  
				  <li class="mt">
                      <div class="btn-group">
                         <button type="button" class="btn btn-default " style="background:#f2f2f2;"><i class="fa fa-link"></i></button>
  ...
  <button type="button"  class="btn btn-default" style="background:#f2f2f2;"><i class="fa fa-paint-brush"></i></button></div>
                     ...
                     <li class="mt">
    <div class="btn-group">
 <button type="button" class="btn btn-default " style="background:#f2f2f2;"><i class="fa fa-text-width"></i>&nbsp; & &nbsp;<i class="fa fa-picture-o"></i> </button>
 
</div>
</li>
 <li class="mt">
    <div class="btn-group">
 <button type="button" class="btn btn-default " style="background:#f2f2f2;"><i class="fa fa-picture-o"></i>&nbsp; & &nbsp;<i class="fa fa-text-width"></i></button>
</div>
</li>
<li>
<div class="btn-group">
 <button type="button" class="btn btn-default " style="background:#f2f2f2;"><i class="fa fa-picture-o"></i></button>
 <button type="button" class="btn btn-default " style="background:#f2f2f2;"><i class="fa fa-text-width"></i></button>
</div>
</li>
                  ...
                  <div class="col-md-8 main-chart" >
		           ...
		           Select Background Color</button>
                      ...
                      <div class="row mt" >
                      	 ...
                      	 <div class="row col-md-12" style="margin-top:-20px;" style="margin-left:-20px;">
						  
           
                   <div id="editor"  contenteditable="true" style="height:560px;  overflow:scroll; border:2px solid  #989898;background:#f2f2f2;"><div class="col-md-11" style="font-size:23px;color:black;"><center>Create Your First Promo Here</center></div><br><br>
				  
                           <img class="img-responsive" src="uploads/banner2.jpg" style="width:800px; height:100px;"><br><br>
						   <table class="table ">
						    
						   <tbody>
						   <tr><td>
						   <div cols="50" rows="5" style="width:550px;height:115px;">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div></td>
...
<!--//tabs-->
    ...
    <div id="menu1" class="tab-pane fade"  style="overflow-y:scroll; overflow-x:hidden; height:525px;">
      ...
      <p><img src="img/design1.png" height=250 width=350></p>
      <p><img src="img/design2.png" height=250 width=350></p>
