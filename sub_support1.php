...
<div class="" >
	<div class="row">
      ...
      <div class="col-md-6 " style="margin-top:15px; ">
        ...
        <p style="font-size: 16px; line-height: 1.7em; font-family:Arial,Helvetica,Verdana,sans-serif;">
...
<p style="font-size: 16px; line-height: 1.7em; ">You'll find a number of resources available to you on the Pyxymail site as you learn more about email marketing, including our video resources, a glossary of terms, and our searchable Knowledge Base of reference, how-to, and troubleshooting articles.</>

<p style="font-size: 16px; line-height: 1.7em; ">When you create an account with us, you agree to Pyxymail's Terms of Use and to comply with anti-spam regulations. It's important that you remain in compliance—if you have questions about CAN-SPAM or other regulations, read through the Compliance Tips articles.
        </p>
...
<p style="font-size: 16px; line-height: 1.7em; ">After you've set up your list, you can add subscribers in three ways:</p>
...
<p style="font-size: 16px; line-height: 1.7em; ">Get step-by-step instructions on creating and importing lists.</p>
...
<p style="font-size: 16px; line-height: 1.7em; ">Learn how to create and design a signup form.</p>
...
<p style="font-size: 16px; line-height: 1.7em; ">The next time you log in to Pyxymail after sending a campaign, you'll see how many subscribers engaged with your recent campaigns right on your Dashboard. You can click over to the Reports section to dig further, and to download, share or print specific reports.</p>
...
<p style="font-size: 16px; line-height: 1.7em; ">Learn more about reports.</p>
