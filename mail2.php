        ...
        <header class="site-header container-fluid" style="width:100%">
            <div class="top-header">
               ...
               <div  class="menu-wrapper">
                       ...
                       <li><a href="logout.php" ><i class="fa fa-user"></i>&nbsp;&nbsp;<?php include 'session1.php';  echo $paid_session; echo $login_session;?></a>
                       <ul>
...
<h2 class="comment-heading"> Send Promotion</h2>
                        ...
                        <form name="comment" method="post" action="send.php" >
                          ...
                          <input type="submit" name="submit" value="Submit" style="background-color:orange;color:black;"/>
                             </p>
                            </form>
                        </div> <!-- /.box-content -->
                    </div> <!-- /.comment-form -->
